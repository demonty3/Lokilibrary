...
/**
 * Hard-coded sample library for the v0.1 feel-test.
 * Replace with a real Steam Web API library fetch once we wire up auth + backend.
...
export const SAMPLE_LIBRARY: GameEntry[] = [
  ...
  { appid: 632470,  name: 'Disco Elysium',   ritualColor: '#5a3a1f', ritualStyle: 'casefile' },
